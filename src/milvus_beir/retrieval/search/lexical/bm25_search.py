...
class MilvusBM25Search(MilvusBaseSearch):
    ...
    def _initialize_collection(self):
        ...
        schema.add_field(field_name=self.bm25_input_field, datatype=DataType.VARCHAR, max_length=65535,
        ...
        bm25_function = Function(
            ...
            input_field_names=[self.bm25_input_field],  # Name of the VARCHAR field containing raw text data
            output_field_names=[self.bm25_output_field],  # Name of the SPARSE_FLOAT_VECTOR field reserved to store generated embeddings
