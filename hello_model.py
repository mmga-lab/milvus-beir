...
from milvus_model.sparse import BM25EmbeddingFunction, SpladeEmbeddingFunction
...
# ]
docs = [
    "Artificial intelligence was founded as an academic discipline in 1956." for _ in range(1000)
]
